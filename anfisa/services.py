...
def what_conclusion(parsed_temperature):
    try:
        ...
        if temperature < 18:
            return 'Сегодня холодно, не стоит есть мороженное!'
        elif 17 < temperature < 28:
            return 'В самый раз съесть порцию моложенного'
        else:
            return 'Сегодня жарко, съешь 2 мороженного!'
    except ValueError:
